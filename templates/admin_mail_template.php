...
<p>This page allows you to send teams their event times via the email that you have for them</p>
    ...
    <form method="POST" action=""><input name="all_teams" type="submit" class="myButton" value="Send All Teams Times"/></form> 
   ...
   <form enctype="multipart/form-data" action="" method="POST">
    Message:<textarea name="message" id="emess" height="100px" width="15%"></textarea><br/><input type="hidden" name="MAX_FILE_SIZE" value="100000" />
